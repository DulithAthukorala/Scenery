...
ELEVEN_TTS_VOICE_ID = os.getenv("ELEVEN_TTS_VOICE_ID", "EXAVITQu4vr4xnSDxMaL")  # Sarah (premade) — free-tier compatible
ELEVEN_TTS_MODEL_ID = os.getenv("ELEVEN_TTS_MODEL_ID", "eleven_multilingual_v2")
