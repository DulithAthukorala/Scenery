...
from routers.voice_ws import router as voice_ws_router
...
app.include_router(voice_ws_router) # voice websocket endpoint, accepts binary audio chunks and will later return transcript events